...
function Home() {
  ...
  return (
    ...
    <section className="section home center">
      ...
      <h2 className="typer">
        <Typewriter options={{
          strings: ["Software Engineer", "Tech Enthusiast", "Curious to learn new things"],
      ...
      <a href="https://drive.google.com/file/d/1N9D8GYXb53GfPQSuEawnJenh606Csup_/view?usp=sharing" target="_blank" id="resumeButton">
